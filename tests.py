...
class TestBooksCollector:
    ...
    def test_add_new_book_adding_three_books_success(self, collection):
        books = ['Гордость и предубеждение', 'Мастер и Маргарита', 'Книга Джунглей']
        for book in books:
    ...
    def test_add_new_book_add_double_books_not_added(self, collection):
        books = ['Мастер и Маргарита', 'Мастер и Маргарита']
        for book in books:
            collection.add_new_book(book)
        assert len(collection.get_books_genre()) == 1

    '''Проверка добавления жанра из списка genre книги из списка books_genre'''
    ...
    '''Проверка изменения жанра из списка genre книги из списка books_genre'''
    ...
    '''Негативная проверка добавления жанра не из списка genre книги из списка books_genre'''
    ...
    def test_get_books_with_specific_genre_success(self, collection_five_books):
        assert collection_five_books.get_books_with_specific_genre('Ужасы') == ['Сияние']
    ...
    def test_get_books_for_children_success(self, collection_five_books):
        ...
        assert len(children_books) == 3 and children_books == ['Властелин колец', 'Король Лев', 'Двеннадцать стульев']
